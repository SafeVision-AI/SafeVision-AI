# SafeVisionAI â€” Product Requirements Document (PRD)
...
| AI Chatbot | SafeVisionAI + DriveLegal | Groq llama3-70b online + Phi-3 Mini offline â€” legal Q&A + first aid |
...
**Total infrastructure cost: â‚¹0** â€” 100% free and open-source stack.

---

## 2. Problem Statements

### 2.1 SafeVisionAI â€” Emergency Response
...
- [ ] Tiered radius fallback: 500m â†’ 1km â†’ 5km â†’ 10km â†’ 25km â†’ 50km
...
- [ ] Automatic authority routing: NHâ†’NHAI, SHâ†’State PWD, MDRâ†’District Collector
...
| Cost | â‚¹0 total infrastructure cost (all free tiers) |
...
| Number of contacts fetched | 7 service categories, 80â€“150 contacts per city at 5km radius |
