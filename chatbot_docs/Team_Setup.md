...
Welcome to the RoadSoS Chatbot development team. To ensure a smooth collaboration and protect the stability of the `SafeVisionAI` platform, please follow these standardized workflow rules.
