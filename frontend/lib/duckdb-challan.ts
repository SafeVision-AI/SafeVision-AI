...
export async function calculateOfflineChallan(violationCode: string, vehicleClass: string, _isRepeat: boolean) {
  ...
  const db = {
    ...
    '194D': { base: 1000, repeat: null, desc: 'Driving without helmet', section: '194D', additional_penalty: '3 mo disqualification' },
  ...
  return {
    ...
    additional_penalty: 'additional_penalty' in result ? result.additional_penalty : null,
  };
}
