        ...
        <section className="flex flex-col gap-8 relative">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 relative z-10">
            <div className="relative group">
              <div className="w-32 h-32 rounded-[2.5rem] border-4 border-white dark:border-white/10 ring-8 ring-emerald-500/5 overflow-hidden relative shadow-2xl transition-transform duration-500 group-hover:scale-105">
                <Image 
                  alt="User Profile" 
            ...
            <div className="text-center sm:text-left flex flex-col gap-2">
              <h2 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white uppercase font-space leading-none">Marcus Thorne</h2>
              <div className="flex items-center justify-center sm:justify-start gap-2">
                <div className="px-2 py-1 bg-slate-100 dark:bg-white/5 rounded-lg border border-slate-200 dark:border-white/10">
                   <span className="text-[9px] font-black text-slate-500 dark:text-emerald-500 uppercase tracking-widest leading-none">ID: SVA-8829-X</span>
                </div>
                <div className="px-2 py-1 bg-amber-500/10 rounded-lg border border-amber-500/20 flex items-center gap-1">
                   ...
                   <span className="text-[9px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest leading-none">Elite Pilot</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-6 rounded-[2rem] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm flex flex-col gap-4">
               ...
               <div className="flex flex-col">
                  <span className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">SV-2024-AI</span>
                  <span className="text-[10px] font-bold text-slate-400 uppercase mt-1">LIDAR-SYNC_ENABLED</span>
               </div>
            </div>
            ...
            <div className="p-6 rounded-[2rem] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm flex flex-col gap-4">
               ...
               <div className="flex flex-col">
                  <span className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">O Negative (O-)</span>
